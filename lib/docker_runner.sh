...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Called from lib/docker_tmp_runner.rb and lib/docker_katas_runner.rb
# NB:
...
#   The same applies to katas/... for DockerKatasRunner.
#
...
#
#   For DockerTmpRunner /tmp must exist on the *host* and be volume mounted into
#   the web-container and then this script (run from inside the web-container) itself
#   volume mounts an *isolated* sub-folder of /tmp
#
#   For DockerKatasRunner .../katas/ must exist on the *host* and be volume mounted into
#   the web-container and then this script (run from inside the web-container) itself
#   volume mounts the avatar's *isolated* sub-folder of .../katas/
#
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
