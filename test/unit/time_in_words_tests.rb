...
class TimeInWordsTests < ActionController::TestCase
  ...
  def test_time_split_unsplit
    ...
    time_split_unsplit_words([0, 0, 1, 1, 0],  3660, '~ 1 hour 1 minute')
    time_split_unsplit_words([0, 0, 1, 1, 1],  3661, '~ 1 hour 1 minute')
    time_split_unsplit_words([0, 0, 1, 1,59],  3719, '~ 1 hour 1 minute')
    time_split_unsplit_words([0, 0, 1, 2, 0],  3720, '~ 1 hour 2 minutes')
    time_split_unsplit_words([0, 0, 2, 0, 0],  7200, '~ 2 hours')
    time_split_unsplit_words([0, 0, 2, 0, 1],  7201, '~ 2 hours')
    time_split_unsplit_words([0, 0, 4,13, 1], 15181, '~ 4 hours 13 minutes')
    time_split_unsplit_words([0, 0,23,59,59], 86399, '~ 23 hours 59 minutes')
    
    time_split_unsplit_words([0, 1, 0, 0, 0],  86400, '~ 1 day')
    time_split_unsplit_words([0, 1, 0, 0, 1],  86401, '~ 1 day')
    time_split_unsplit_words([0, 1, 1, 0, 0],  90000, '~ 1 day 1 hour')
    time_split_unsplit_words([0, 1, 3, 0, 0],  97200, '~ 1 day 3 hours')
    time_split_unsplit_words([0, 2, 0, 0, 1], 172801, '~ 2 days')
    time_split_unsplit_words([0, 2, 3, 0, 1], 183601, '~ 2 days 3 hours')
    time_split_unsplit_words([0, 2,11, 0, 1], 212401, '~ 2 days 11 hours')
    ...
    time_split_unsplit_words([1, 1, 0, 0,15], 31622415, '~ 1 year 1 day')
    time_split_unsplit_words([1,43, 0, 0,15], 35251215, '~ 1 year 43 days')
    time_split_unsplit_words([2, 0, 0, 0, 0], 63072000, '~ 2 years')    
    time_split_unsplit_words([2, 0, 0, 0, 2], 63072002, '~ 2 years')    
    time_split_unsplit_words([2,56, 0, 0, 2], 67910402, '~ 2 years 56 days')    
  end
