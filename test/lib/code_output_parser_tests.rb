...
class CodeOutputParserTests < ActionController::TestCase
  ...
  test "terminated by the server after 10 seconds is amber" do
    amber_output = "Terminated by the cyber-dojo server after 10 seconds"
  ...
  test "perl one failing test is red" do
    ...
    assert_equal :red, CodeOutputParser::parse_perl_test_simple(red_output)                    
  end
  ...
  test "perl one passing test is green" do
    ...
    assert_equal :green, CodeOutputParser::parse_perl_test_simple(green_output)                        
  end
