...
class CodeOutputParserTests < ActionController::TestCase
  ...
  test "Groovy-Spock syntax error of the first kind is amber" do
    output =
    [
      "JUnit version 4.10",
      ".E",
    ...
    assert_equal :amber, CodeOutputParser::parse_groovy_spock(output)                              
  end
  
  test "Groovy-Spock syntax error of the second kind is amber" do
    output =
    [
  ...
  test "Groovy-Spock test fail is red" do
    output =
    [
      "JUnit version 4.10",
      ".E",
  ...
  test "Groovy-Spock test pass is red" do
    output =
    [
      "JUnit version 4.10",
      ".",
    ...
    assert_equal :green, CodeOutputParser::parse_groovy_spock(output)                                      
  end
  
  test "Groovy-Spock test with no assertions is red" do
    output =
    [
      "JUnit version 4.10",
      "",
