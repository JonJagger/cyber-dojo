...
class FoldersTests < ActionController::TestCase
  ...
  test "id_complete with no matching id is unchanged id" do
    make_dir(@dojo.dir + '/katas/12/345ABCDE/wolf')
    assert_equal '123AEEE', Folders::id_complete(@dojo.dir, '123AEEE')    
  end
  
  test "id_complete with one matching id is found and returned as id" do
    make_dir(@dojo.dir + '/katas/12/3579BCDE/wolf')
    assert_equal '123579BCDE', Folders::id_complete(@dojo.dir, '1235')
  end
  
  test "id_complete with two matching ids found is unchanged id" do
    # 12/345... and 12/346... diff is in 5th character
    make_dir(@dojo.dir + '/katas/12/345ABCDE/wolf')
    make_dir(@dojo.dir + '/katas/12/346ABCDE/wolf')
    assert_equal '1234', Folders::id_complete(@dojo.dir, '1234')    
  end
